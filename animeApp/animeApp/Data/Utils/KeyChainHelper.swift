...
final class KeyChainHelper {
    ...
    func save(data: Data, service: String = "iOSAnimeApp", account: String) {
    ...
    func read(service: String = "iOSAnimeApp", account: String) -> Data? {
    ...
    func delete(service: String = "iOSAnimeApp", account: String) {
